      ...
      <AnimatePresence>
        {showSuccess && (
          <motion.div
            ...
            className="fixed top-24 left-1/2 -translate-x-1/2 z-50 glass-card rounded-2xl px-6 py-4 neon-border flex items-center gap-3"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-10">
          {contactInfo.map((info, index) => (
            ...
            >
              <div className="absolute -inset-0.5 rounded-2xl blur-lg opacity-0 group-hover:opacity-60 transition-opacity duration-500 bg-gradient-to-br from-primary/30 to-secondary/30" />
              <div className="relative glass-card rounded-2xl p-5 sm:p-6 h-full">
                <div className={`w-11 h-11 rounded-xl ${info.bg} flex items-center justify-center mb-4`}>
                  <info.icon className={`w-6 h-6 ${info.color}`} />
                </div>
                <h3 className="font-semibold text-white mb-2">{info.label}</h3>
                <div className="space-y-0.5">
                  {info.lines.map((line) => (
                    <p key={line} className="text-sm text-gray-400 leading-relaxed">{line}</p>
                  ))}
                </div>
              </div>
            </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-2 glass-card rounded-3xl p-6 sm:p-8 neon-border"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 py-3.5 rounded-xl btn-primary text-white font-semibold flex items-center justify-center gap-2"
                >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 sm:flex-none sm:px-8 py-3.5 rounded-xl btn-outline text-white font-semibold flex items-center justify-center gap-2"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="glass-card rounded-3xl p-6 sm:p-8 flex flex-col"
          >
            ...
            <div className="relative rounded-2xl overflow-hidden mb-5 h-44 bg-gradient-to-br from-primary/20 via-secondary/10 to-transparent flex items-center justify-center">
              <div
              ...
              >
                <div className="relative">
                  <motion.div
                    ...
                    className="absolute -inset-3 rounded-full bg-secondary/40 blur-md"
                  />
            ...
            <div className="space-y-1 mb-5">
              <p className="text-sm font-medium text-white">Dadi Institute of Engineering and Technology</p>
              <p className="text-sm text-gray-400">Anakapalle</p>
              <p className="text-sm text-gray-400">Andhra Pradesh, India</p>
            </div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="mt-auto w-full py-3 rounded-xl btn-primary text-white font-semibold flex items-center justify-center gap-2"
            >
